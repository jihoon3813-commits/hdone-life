...
export default function PhilosophyPage() {
  ...
  const coreValues = [
    {
      image: "https://res.cloudinary.com/lyjyvy54/image/upload/v1785308928/ChatGPT_Image_2026%EB%85%84_7%EC%9B%94_29%EC%9D%BC_%EC%98%A4%ED%9B%84_04_00_09_1_ra2uyh.png",
      title: "고객 중심 (Customer First)",
      desc: "고객의 상황과 마음을 누구보다 먼저 헤아리며 365일 24시간 언제나 진정성 있게 다가섭니다.",
    },
    {
      image: "https://res.cloudinary.com/lyjyvy54/image/upload/v1785308927/ChatGPT_Image_2026%EB%85%84_7%EC%9B%94_29%EC%9D%BC_%EC%98%A4%ED%9B%84_04_00_09_3_ytp06r.png",
      title: "신뢰 (Trust)",
      desc: "투명하고 정직한 운영을 바탕으로 언제나 안심하고 믿고 맡길 수 있는 라이프 파트너가 됩니다.",
    },
    {
      image: "https://res.cloudinary.com/lyjyvy54/image/upload/v1785308929/ChatGPT_Image_2026%EB%85%84_7%EC%9B%94_29%EC%9D%BC_%EC%98%A4%ED%9B%84_04_00_10_4_cudv7p.png",
      title: "정직 (Honesty)",
      desc: "불필요한 부풀리기나 과장 없이 정찰된 품목과 품질 원칙을 엄격하게 준수합니다.",
    },
    {
      image: "https://res.cloudinary.com/lyjyvy54/image/upload/v1785308928/ChatGPT_Image_2026%EB%85%84_7%EC%9B%94_29%EC%9D%BC_%EC%98%A4%ED%9B%84_04_00_09_2_dl6maq.png",
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-8 w-full flex-1 space-y-16">
        ...
        {/* 4 Core Values Grid - Premium Image Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {coreValues.map((val, idx) => (
            <div
              key={idx}
              className="group bg-white rounded-3xl border border-slate-200/90 shadow-md hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col justify-between"
            >
              <div className="w-full h-56 bg-slate-50 overflow-hidden relative border-b border-slate-100 p-2 flex items-center justify-center">
                <img
                  src={val.image}
                  alt={val.title}
              ...
              <div className="p-6 sm:p-8 space-y-3 bg-white flex-1 flex flex-col justify-center">
