    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="py-16 max-w-5xl mx-auto px-4 sm:px-8 w-full flex-1 space-y-16">
        ...
        <div className="w-full overflow-hidden rounded-sm border border-slate-200 shadow-md">
          <img
            src="https://res.cloudinary.com/lyjyvy54/image/upload/v1785308929/ChatGPT_Image_2026%EB%85%84_7%EC%9B%94_29%EC%9D%BC_%EC%98%A4%ED%9B%84_03_38_13_4_tlqjoy.png"
            alt="펫장례 서비스 안내"
